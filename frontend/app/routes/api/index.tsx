...
axios.defaults.baseURL = "http://34.168.230.139/api/";
...
export const getGroupDebts = (groupId: string) => {
  return getWithAuth(`groups/debts/${groupId}`);
};

export const equalizeGroupDebts = (groupId: string) => {
  return getWithAuth(`groups/equalize/${groupId}`);
};

export const getGroupMinimizedDebts = (groupId: string) => {
